...
// ArkivBlockHeader is the subset of a sealed block header the chain server needs.
...
type CommitChainRequest struct {
	Blocks []ArkivBlock `json:"blocks"`
}

// RevertRequest is the parameter object for arkiv_revert.
type RevertRequest struct {
	Blocks []ArkivBlockRef `json:"blocks"`
}

// ReorgRequest is the parameter object for arkiv_reorg.
type ReorgRequest struct {
	RevertedBlocks []ArkivBlockRef `json:"revertedBlocks"`
	NewBlocks      []ArkivBlock    `json:"newBlocks"`
}
